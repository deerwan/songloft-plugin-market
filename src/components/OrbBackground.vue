<!--
  ...
  modified by pengzhanbo (vuepress-theme-plume), ported to this project.
  持续流动的 WebGL 光球背景，始终在动；尊重 prefers-reduced-motion 降级。
-->
...
<template>
  <div ref="ctnDom" :class="`orb-bg ${className}`" aria-hidden="true" />
</template>
